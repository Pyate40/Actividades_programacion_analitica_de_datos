...
fin_semana = df[df["dia"].isin(["Sat", "Sun"])]
entre_semana = df[~df["dia"].isin(["Sat", "Sun"])]

print("Propina promedio fin de semana:",
      propina_promedio(fin_semana), "%")

print("Propina promedio resto de la semana:",
      propina_promedio(entre_semana), "%")

# Reto 2: su código aquí
mesas_grandes = df[df["personas"] >= 4]
mesas_pequenas = df[df["personas"]<3]

print("Propina promedio mesas grandes:",
      propina_promedio(mesas_grandes), "%")

print("Propina promedio mesas pequeñas:",
      propina_promedio(mesas_pequenas), "%")
...
print("Cuenta promedio cena:",
      cuenta_promedio(cenas))

print("Cuenta promedio almuerzo:",
      cuenta_promedio(almuerzos))
