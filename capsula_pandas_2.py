...
cenas_aplicacion = df[
    (df["categoria"] == "Cena") &(df["canal"] == "Aplicación")]
print("Cenas por aplicación:",
      resumen_dinero(cenas_aplicacion))

# Reto 2: su código aquí

condicion = (
    (df["cantidad"] == 1) | (df["categoria"] == "Bebida"))

pequenos_o_bebidas = df[condicion]
resto_pedidos = df[~condicion]

utilidad_pequenos = resumen_dinero(pequenos_o_bebidas)["utilidad"]
utilidad_resto = resumen_dinero(resto_pedidos)["utilidad"]

print("Utilidad de pedidos pequenos o bebidas:", utilidad_pequenos)
print("Utilidad del resto de pedidos:", utilidad_resto)
...
print("Margen promedio del salón:",
      margen_promedio(salon), "%")

print("Margen promedio de la aplicación:",
      margen_promedio(aplicacion), "%")
